...
@cell-border-color: darken(@base, 1%);
...
@primary-button-border-color: darken(@accent, 5%);
...
.k-toolbar:not(.k-spreadsheet-toolbar) .k-button-group {
    .k-button {
...
.k-split-button:focus {
    background-color: @button-background-color;
    box-shadow: 0 0 8px 0 lighten(@accent, 13%);
}
