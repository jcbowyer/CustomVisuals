...
@sprite-image-2x: url('@{image-folder}/sprite_2x.png');
@sprite-kpi-image: url('@{image-folder}/sprite_kpi.png');
@sprite-kpi-image-2x: url('@{image-folder}/sprite_kpi_2x.png');
...
@primary-focused-color: #ffffff;
@primary-focused-border-color: #eff8ff;
@primary-focused-gradient: none;
@primary-focused-active-item-shadow: 0 0 8px 0 #cfe6f8;
...
@primary-active-shadow: 0 6px 17px 0 rgba(0, 0, 0, 0.3);
@primary-disabled-text-color: #a8a8a8;
@primary-disabled-background-color: #eaeaea;
@primary-disabled-border-color: #eaeaea;
...
@button-focused-border-color: contrast(@background, lighten(@background, 17%), darken(@background, 14%), 0.5);
...
.k-split-button:focus > .k-button.k-split-button-arrow {
    border-left-color: @alt-background-color;
}
...
border-color: @panelbar-items-border;
    ...
    .k-toggle-button {
        &:focus {
            background-color: transparent;
            border-color: contrast(@background, darken(@base, 30%), lighten(@base, 30%), 0.5);
        }
