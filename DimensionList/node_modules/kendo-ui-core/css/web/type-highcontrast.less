...
@primary-button-text-color: @normal-text-color;
@primary-button-background-color: darken(@hover-background, 6%);
@primary-button-border-color: desaturate(@hover-background, 2%);
...
@primary-focused-color: @normal-text-color;
@primary-focused-border-color: @normal-text-color;
@primary-focused-gradient: @selected-gradient;
@primary-focused-active-item-shadow: 0 0 3px 0 #fff;
...
.k-split-button:focus {
    box-shadow: inset 0 0 4px 2px @button-text-color;
}
