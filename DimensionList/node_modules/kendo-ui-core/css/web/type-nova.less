...
.k-listbox .k-button.k-state-disabled {
    ...
    border-color: lighten(@hover-text-color, 20%);
    background-color: @widget-background-color;
}
...
.k-primary.k-state-disabled:active {
    color: @selected-text-color;
    border-color: lighten(@accent, 18%);
    background-color: lighten(@accent, 18%);
}
...
.k-widget.k-notification.k-notification-info {
    color: darken(@info, 38%);
    background-color: @info;
    border-color: @info;
}

.k-widget.k-notification.k-notification-success {
    color: darken(@success, 27%);
    background-color: @success;
    border-color: @success;
}

.k-widget.k-notification.k-notification-warning {
    color: darken(@warning, 27%);
