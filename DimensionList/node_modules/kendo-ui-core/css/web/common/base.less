...
.sprite-hoverable(@row, @column, @size: @grid-size) when not (ispixel(@column)) and not (@icon-positioning = "material") {
...
// sprite positioning for material theme
.sprite-hoverable(@row, @column, @size: @grid-size) when not (ispixel(@column)) and (@icon-positioning = "material") {
    .sprite-position(@row, @column, @size);
