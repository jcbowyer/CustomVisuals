...
@column-highlight-background-color: contrast(@base, lighten(@base, 8%), darken(@base, 1%), 0.5);
...
@button-focused-border-color: contrast(@base, lighten(@base, 14%), darken(@base, 14%), 0.5);
@button-focused-shadow: inset 0 0 0 1px @hover-border-color;
